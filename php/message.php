...
// Reading reCAPTCHA secret key from form_recaptcha.conf
$recaptchaConfig = parse_ini_file("../config/form_recaptcha.conf");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$response->success) {
        ...
        exit;  // Stop further execution if CAPTCHA fails
    }
