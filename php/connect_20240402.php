...
include('db.php');
    ...
    if (
        //v1.8 !empty($_POST['f_firstname']) && !empty($_POST['f_lastname']) && !empty($_POST['f_gender']) &&
        !empty($_POST['f_firstname']) && !empty($_POST['f_gender']) &&
       ...
       ) 
       {
        ...
        //v 1.8 $lastname           =  mysqli_real_escape_string($conn, trim($_POST['f_lastname']));
        $lastname           =  isset($_POST['f_lastname']) ? mysqli_real_escape_string($conn, trim($_POST['f_lastname'])) : ''; //v1.8
